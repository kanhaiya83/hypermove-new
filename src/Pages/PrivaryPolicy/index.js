...
const PrivacyPolicyPage = () => {
  return (
      <Container>
        <div className=" header-top-padding mx-auto flex flex-col items-stretch text-slate-100 py-16">
          <h1 className="text-3xl text-center my-4">
            Privacy Policy for Hypermove 
          </h1>
          <p className="mb-4">
          ...
          <p className="mb-2">
            Hypermove uses the collected data for various purposes:
          </p>
...
<p className="mb-3">
Hypermove will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
<h1 className="text-2xl mt-4 mb-2">Disclosure of Data</h1>
<h1 className="text-2xl mt-4 mb-2">Legal Requirements</h1>
<p className="ml-[5%]">Hypermove may disclose your Personal Data in the good faith belief that such action is
</p>
        </div>
      </Container>
  );
